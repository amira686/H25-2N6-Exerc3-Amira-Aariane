...
print(f"Voici le courriel de l'etudiant qui a été ajouter :{etudiant['courriel']}")
...
print(f"Voici le nouveau courriel de l'etudiant qui a été ajouter :{etudiant['courriel']}")
...
age_retirer = etudiant.pop('age')

print(f" on a enlevé l'âge de l'étudiant, sa valeur était: {age_retirer}")
...
print(f"Nous avons maintenant {len(etudiant)} paires de clés valeur")